...
const client = Client.buildClient({
  storefrontAccessToken: '4268034f30630923c583d9bdf9c602aa',
  domain: 'gettrusupps.myshopify.com',
});
...
async function addDiscount (checkoutId, discountCode) {
  try {
    return await client.checkout.addDiscount(checkoutId, discountCode);
  } catch (e) {
    console.log(e);
    return e
  }
